...
void LoadInternal(ExtensionLoader &loader) {
	...
	config.AddExtensionOption("httpfs_timeout_open", "Timeout for opening files (in milliseconds)", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_TIMEOUT_MS));
	config.AddExtensionOption("httpfs_timeout_read", "Timeout for reading files (in milliseconds)", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_TIMEOUT_MS));
	config.AddExtensionOption("httpfs_timeout_write", "Timeout for writing files (in milliseconds)", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_TIMEOUT_MS));
	config.AddExtensionOption("httpfs_timeout_list", "Timeout for listing directories (in milliseconds)", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_TIMEOUT_MS));
	config.AddExtensionOption("httpfs_timeout_delete", "Timeout for deleting files (in milliseconds)", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_TIMEOUT_MS));
	...
	config.AddExtensionOption("httpfs_retries_open", "Maximum number of retries for opening files", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
	config.AddExtensionOption("httpfs_retries_read", "Maximum number of retries for reading files", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
	config.AddExtensionOption("httpfs_retries_write", "Maximum number of retries for writing files", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
	config.AddExtensionOption("httpfs_retries_list", "Maximum number of retries for listing directories", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
	config.AddExtensionOption("httpfs_retries_delete", "Maximum number of retries for deleting files", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
	config.AddExtensionOption("httpfs_retries_connect", "Maximum number of retries for establishing connections", LogicalType::UBIGINT,
	                          Value::UBIGINT(DEFAULT_RETRIES));
